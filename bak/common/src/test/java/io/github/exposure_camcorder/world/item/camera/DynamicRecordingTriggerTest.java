...
class DynamicRecordingTriggerTest {
    @Test
    void durationBudgetScalesWithFilmCapacity() {
        DynamicRecordingTrigger trigger = new DynamicRecordingTrigger();

        assertEquals(160, trigger.calculateDurationBudgetTicks(40, 2, 320, 320, 80));
        assertEquals(320, trigger.calculateDurationBudgetTicks(40, 2, 640, 320, 80));
