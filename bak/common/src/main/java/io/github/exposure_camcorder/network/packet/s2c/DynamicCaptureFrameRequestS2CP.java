...
public record DynamicCaptureFrameRequestS2CP(String sessionId, int frameIndex, String exposureId,
                                             CaptureParameters captureParameters) implements Packet, HandledPayload, CustomPacketPayload {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, DynamicCaptureFrameRequestS2CP> STREAM_CODEC = StreamCodec.composite(
