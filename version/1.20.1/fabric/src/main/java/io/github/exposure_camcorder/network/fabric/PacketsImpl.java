package io.github.exposure_camcorder.network.fabric;
...
public final class PacketsImpl {
    ...
    public static void sendToServer(HandledPayload packet) {
        io.github.exposure_camcorder.fabric.network.PacketsImpl.sendToServer(packet);
    }

    public static void sendToClient(HandledPayload packet, ServerPlayer player) {
        io.github.exposure_camcorder.fabric.network.PacketsImpl.sendToClient(packet, player);
    }
}
