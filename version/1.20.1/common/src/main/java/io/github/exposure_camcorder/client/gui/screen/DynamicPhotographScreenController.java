...
public class DynamicPhotographScreenController {
    ...
    public void open(ItemStack stack) {
        DynamicPhotographFrames stackFrames = io.github.exposure_camcorder.util.DynamicItemStackData.getDynamicPhotographFrames(stack, DynamicPhotographFrames.EMPTY);
        DynamicPhotographSettings stackSettings = io.github.exposure_camcorder.util.DynamicItemStackData.getDynamicPhotographSettings(stack, DynamicPhotographSettings.DEFAULT);
        DynamicPhotographSummary stackSummary = io.github.exposure_camcorder.util.DynamicItemStackData.getDynamicPhotographSummary(stack,
