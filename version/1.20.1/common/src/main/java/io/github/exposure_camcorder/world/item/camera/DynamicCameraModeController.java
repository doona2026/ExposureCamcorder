...
public class DynamicCameraModeController {
    public DynamicCameraModeState getState(ItemStack stack) {
        return io.github.exposure_camcorder.util.DynamicItemStackData.getDynamicCameraModeState(stack, defaultState());
    }
    ...
    public DynamicCameraModeState syncState(ItemStack stack, Player player) {
        ...
        io.github.exposure_camcorder.util.DynamicItemStackData.setDynamicCameraModeState(stack, synced);
        return synced;
    }
    ...
    public DynamicCameraModeState toggleMode(ItemStack stack, Player player) {
        ...
        io.github.exposure_camcorder.util.DynamicItemStackData.setDynamicCameraModeState(stack, updated);
        return updated;
    }
